...
<template>
  ...
  >
    <PrismicText
      ...
      wrapper="h2"
      class="max-w-2xl text-balance text-center text-5xl md:text-7xl font-medium"
    />
    <PrismicRichText
    ...
    <div class="mt-20 grid gap-16">
      <article
        ...
        :key="caseStudy.id"
        class="group relative grid gap-4 opacity-85 transition-opacity will-change-auto duration-300 hover:opacity-100 hover:cursor-pointer md:grid-cols-2 lg:grid-cols-3 md:gap-8"
      >
        ...
        <div class="relative lg:col-span-2" :class="index % 2 && 'md:-order-1'">
          ...
          <PrismicImage
            ...
            class="z-20 scale-[0.98] rounded-xl transition-transform will-change-transform duration-300 group-hover:scale-100"
          />
        </div>
      </article>
    </div>
